...
namespace GameStore.Api.Data.Migrations
{
    ...
    [Migration("20250202121940_AddRolesTableAgain")]
    partial class AddRolesTableAgain
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GameStore.Api.Entities.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("GameStore.Api.Entities.User", b =>
                {
                    b.HasOne("GameStore.Api.Entities.Role", "Role")
                        .WithMany("Users")
